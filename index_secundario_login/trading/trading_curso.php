...
<body>
  ...
  <main class="contenedor">
    <section id="informacion-curso">
        ...
        <p>Este curso de Trading, está completo en un solo video.</p>
      
        <iframe width="800" height="400" src="https://www.youtube.com/embed/Z-11MBl5zkA?si=-7zlEu7Y8xfJVDGf&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe><br></br>
