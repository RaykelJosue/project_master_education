...
<body>
  ...
  <main class="contenedor">
    <section id="informacion-curso">
        ...
        <p>En este capítulo aprenderás qué es una IP Pública.</p>
        
        
        <iframe width="800" height="400" src="https://www.youtube.com/embed/gVUE2IDwWA0?si=V9f93XoW5JYYAnkO&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe><br></br>
