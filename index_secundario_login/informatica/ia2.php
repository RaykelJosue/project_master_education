...
<body>
  ...
  <main class="contenedor">
    <section id="informacion-curso">
        <h1>Manejo de datos en la Inteligencia Artificial</h1>
        <p>En este capítulo aprenderás el manejo de los datos en la inteligencia artificial.</p>
      
      
        <iframe width="800" height="400" src="https://www.youtube.com/embed/3CxPoh5g158?si=Aa5woOiMj-M0Hon-&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe><br></br>
