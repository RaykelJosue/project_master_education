...
<body>
  ...
  <main class="contenedor">
    <section id="informacion-curso">
        ...
        <p>En este capítulo aprenderás los fundamentos de la programación con Python, uno de los lenguajes más populares y versátiles del mundo.</p>
      
        <p>Video introductorio:</p>
      
        <iframe width="800" height="400" src="https://www.youtube.com/embed/mENHDQ8SLsI?si=48OCwFSW4xtzyHx_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe><br></br>
