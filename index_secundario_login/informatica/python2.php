...
<body>
  ...
  <main class="contenedor">
    <section id="informacion-curso">
      <h1>Ejecución y compilación de un programa con Python</h1>
      ...
      <iframe width="800" height="400" src="https://www.youtube.com/embed/UzHFkEdnRuc?si=6RlJu5aOjeLml-UT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe> <br></br>
      ...
      <a href="python_form.php" class="btn">Realizar cuestionario</a>
    </section>
  </main>
  <footer>
