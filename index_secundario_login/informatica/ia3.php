...
<body>
  ...
  <main class="contenedor">
    <section id="informacion-curso">
        <h1>Pandas de la Inteligencia Artificial</h1>
        <p>En este capítulo aprenderás sobre los Pandas de la inteligencia artificial.</p>
            
        <iframe width="800" height="400" src="https://www.youtube.com/embed/XoiiRelVBys?si=c9-Wq8cSUS1vqRG7&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe><br></br>
