...
<body>
  ...
  <main class="contenedor">
    <section id="informacion-curso">
        <h1>Curso de Redes Informáticas</h1>
        <p>En este capítulo aprenderás qué es una IP Privada, NAT y Gateway.</p>
        
        
        <iframe width="800" height="400" src="https://www.youtube.com/embed/HeZWcZmrQUY?si=_PuIvrGnTHkmpWT9&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe><br></br>
        ...
        <a href="redes_form.php" class="btn">Realizar cuestionario</a>
      </section>
